...
export default class Wall extends Component {
  ...
  render() {
    //test
    let data = [{author: {id: 1, isGroup: false, name: "Maciej Owerczuk"}, to:{id: 2, isGroup: true, name: "Sportowe świry"}, date:"18 października o 14:34", content:"Siema ziomeczki, jak ktoś chce pograć dzisiaj w piłkę z prawdziwymi koksami niech wpada o 20:00 na Zachodnią!!! pozdro"},
    ...
    let posts = data.map((item, index) => <Post author={item.author} to={item.to} 
